...
public class PostServiceImpl implements PostService {
	...
	// private String uploadDir = "C:/Users/user1/Desktop/saveImage"; 위 코드와 같음
	...
	public void uploadImages(MultipartFile[] files, String title, String content) {
		...
		if(!uploadDirFile.exists()) {
			...
			if (!uploadDirFile.mkdirs()) {// mkdir = 폴더 1개 mkdirs = 하위폴더 모두 생성
		...
		try {
			...
			// 이미지들 이미지를 한개 씩 담아오기 map -> 이미지를 하나씩 가져올 때 stream을 이용해서 가져오고
